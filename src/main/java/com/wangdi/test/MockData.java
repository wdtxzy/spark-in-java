...
import com.wangdi.util.DateUtils;
import com.wangdi.util.StringUtils;
...
/**
 * @ Author ：wang di
 * @ Date   ：Created in 5:26 PM 2018/10/30
 */
public class MockData {
    ...
    public static void mock(JavaSparkContext sc,
        ...
        String[] searchKeywords = new String[] {"火锅","日料","烤肉","鸡公煲","海底捞",
                "iPhone","川菜","Nike","粤菜","烤串"};
